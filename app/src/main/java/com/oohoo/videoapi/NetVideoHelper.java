...
//        }
//    };
//    private static final Map<NetVideoFrom, String> HomeUrlAPI = new HashMap<NetVideoFrom, String>(){
//        {
//            put(NetVideoFrom.Live,"http://i.rcuts.com/update/938");
//            put(NetVideoFrom.YouKu,"http://www.youku.com");
//            put(NetVideoFrom.QQLive,"http://m.v.qq.com");
//            put(NetVideoFrom.IQiYi,"http://m.iqiyi.com");
...
//        }
//    };
//    private static final Map<NetVideoFrom, String> searchAPI = new HashMap<NetVideoFrom, String>(){
//        {
...
//        String extraUrl = nv.getExtraUrl();
//        String api = String.format(Objects.requireNonNull(videoUrlApi.get(type)), extraUrl);
//        String retStr;
...
//                break;
//            case CloudMusic:
//                if (!extraUrl.matches("^\\d+$")){
//                    api = CloudMusicAnalyze.getApiByCloudVideoId(extraUrl);
...
//            case Live:
//                retStr = sendDataByGet(api,"Android");
//                list = LiveAnalyze.getVideoListByHome(retStr);
//                break;
//            case YouKu:
//                retStr = sendDataByGet(api,"Android");
...
//                break;
//            case DouBanTop250:
//                list = DouBanTop250Analyze.getVideoListByHome();
//                break;
//        }
//        return list;
//    }
